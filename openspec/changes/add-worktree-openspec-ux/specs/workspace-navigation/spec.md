...
The system SHALL provide collapsible sections whose headers identify the change name and progress for change sections, or the worktree name and checked-out branch or detached revision when available for other worktree sections. Collapsed state SHALL be retained locally across reloads by stable section identity.
...
- **THEN** it presents the same grouping, selection, and section actions available in the desktop sidebar
